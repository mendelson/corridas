...
_MODULE_TO_NAME: dict[str, str] = {
    ...
    # International
    "evento_unico/cardiff_half":   "Cardiff Half Marathon",
    # World Marathon Majors
    "evento_unico/tokyo":          "Tokyo Marathon",
    "evento_unico/boston":         "Boston Marathon",
    "evento_unico/brighton":       "Brighton Marathon",
    "evento_unico/paris":          "Paris Marathon",
    "evento_unico/london":         "TCS London Marathon",
    "evento_unico/prague":         "Prague Marathon",
    "evento_unico/copenhagen":     "Copenhagen Marathon",
    "evento_unico/edinburgh":      "Edinburgh Marathon Festival",
    "evento_unico/stockholm":      "Stockholm Marathon",
    "evento_unico/manchester":     "Manchester Marathon",
    "evento_unico/sydney":         "TCS Sydney Marathon",
    "evento_unico/great_north_run": "Great North Run",
    "evento_unico/berlin":         "BMW Berlin Marathon",
    "evento_unico/manchester_half": "Manchester Half Marathon",
    "evento_unico/chicago":        "Bank of America Chicago Marathon",
    "evento_unico/amsterdam":      "Amsterdam Marathon",
    "evento_unico/venice":         "Venice Marathon",
    "evento_unico/dublin":         "Dublin City Marathon",
    "evento_unico/nyc":            "TCS New York City Marathon",
    "evento_unico/athens":         "Athens Classic Marathon",
    "evento_unico/valencia":       "Valencia Marathon",
}
