"""Scraper for portaldascorridas.com.br — Playwright (SPA)"""
...
URL = "https://www.portaldascorridas.com.br/"
BASE = "https://www.portaldascorridas.com.br"
...
def _find_events(soup):
    for sel in [".event", ".race", ".card", "article", ".item", ".post", "li"]:
        els = soup.select(sel)
        if len(els) > 1:
            return els
    return []
