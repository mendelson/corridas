...
| Atletis<!--atletis--> | ✅ | `atletis.com.br/events/coordinates` | GeoJSON + JSON-LD por evento | 2026-05-29 15:03 | ❌ 53/66 eventos sem distâncias | — |
| Brasil Corrida<!--brasil_corrida--> | ✅ | `brasilcorrida.com.br/api/src/Site` | JSON API | 2026-05-29 15:03 | ❌ 1/14 eventos sem distâncias | 2026-05-25 13:23 |
...
| Fonte | Em uso | URL de busca | Método | Testado em | Status | Últ. sucesso |
| --- | --- | --- | --- | --- | --- | --- |
| Correr Brasília<!--correr_brasilia--> | ✅ | `correrbrasilia.com.br/calendario/` | HTML | 2026-05-29 15:03 | ❌ 26/65 eventos sem distâncias | 2026-05-26 01:32 |
| Bora Correr<!--bora_correr--> | ✅ | `coelhodeprograma.com.br/boracorrer` | HTML (tabela #tabDados) | 2026-05-29 15:03 | ❌ 1/46 eventos sem distâncias | 2026-05-26 01:31 |
| Brasil que Corre<!--brasil_que_corre--> | ✅ | `brasilquecorre.com/distritofederal` | HTML (cs-text-widget) | 2026-05-29 15:02 | ❌ 46/46 eventos sem horário | 2026-05-25 13:24 |
| SESC DF<!--sesc_df--> | ✅ | `sescdf.com.br/corridas` | HTML | 2026-05-29 15:03 | ❌ 1/1 eventos sem horário | 2026-05-25 13:24 |

### Fontes brasileiras — eventos específicos

| Fonte | Em uso | URL de busca | Testado em | Status | Últ. sucesso |
| --- | --- | --- | --- | --- | --- |
| Maratona do Rio<!--maratona_rio--> | ✅ | `maratonadorio.com.br` | 2026-05-29 15:02 | ✅ | 2026-05-29 15:02 |
| Maratona de Porto Alegre<!--maratona_porto_alegre--> | ✅ | `maratonadeportoalegre.com.br` | 2026-05-29 15:04 | ✅ | 2026-05-29 15:04 |
| SP City Marathon<!--sp_city_marathon--> | ✅ | `iguanasports.com.br/products/sp-city-marathon-{ano}` | 2026-05-29 15:04 | ✅ | 2026-05-29 15:04 |
| São Silvestre<!--sao_silvestre--> | ✅ | `saosilvestre.com.br` | 2026-05-29 15:02 | ❌ 1/1 eventos sem horário | 2026-05-25 13:24 |
| Volta do Lago<!--volta_do_lago--> | ✅ | `largadaesportiva.com.br/api/Events` | 2026-05-29 15:03 | ✅ | 2026-05-29 15:03 |

### Fontes mexicanas

| Fonte | Em uso | URL de busca | Observação | Testado em | Status | Últ. sucesso |
| --- | --- | --- | --- | --- | --- | --- |
| Asdeporte<!--asdeporte--> | ✅ | `asdeporte.com/eventos` | Next.js; extrai `pageProps.recomended` do `__NEXT_DATA__`; ~30 eventos/run | 2026-05-29 15:04 | ❌ 20/34 eventos sem distâncias | 2026-05-25 13:23 |

### Fontes internacionais — plataformas agregadoras

| Fonte | Em uso | URL de busca | Observação | Testado em | Status | Últ. sucesso |
| --- | --- | --- | --- | --- | --- | --- |
| HalfMarathons.net<!--halfmarathons--> | ✅ | `halfmarathons.net/wp-json/wp/v2/races` | WordPress REST API paginada (EUA); distâncias em milhas como string | 2026-05-29 15:05 | ❌ 112/1973 eventos sem distâncias | 2026-05-25 20:20 |
| RunSignup<!--runsignup--> | ✅ | `runsignup.com/Rest/races` | REST API paginada (EUA/global); distâncias em milhas preservadas como string | 2026-05-29 15:05 | ✅ | 2026-05-29 15:05 |
| World Athletics<!--world_athletics--> | ✅ | `worldathletics.org/competitions/world-athletics-label-road-races` | HTML público; `__NEXT_DATA__`; provas com Label IAAF (Platinum/Gold/Silver/Bronze) | 2026-05-29 15:03 | ❌ 121/121 eventos sem horário | 2026-05-25 20:19 |
| Race Roster<!--raceroster--> | ✅ | `search.raceroster.com/search` | REST API pública; paginada por termo de busca; distâncias parseadas de strings como `42km`/`3mi` | 2026-05-29 15:03 | ✅ | 2026-05-29 15:03 |
...
| --- | --- | --- | --- | --- | --- | --- |
| Tokyo Marathon<!--majors/tokyo--> | ⭐ | ✅ | `marathon.tokyo/en` | 2026-05-29 15:02 | ✅ | 2026-05-29 15:02 |
| Boston Marathon<!--majors/boston--> | ⭐ | ✅ | `baa.org/races/boston-marathon` | 2026-05-29 15:03 | ✅ | 2026-05-29 15:03 |
| TCS London Marathon<!--majors/london--> | ⭐ | ✅ | `tcslondonmarathon.com` | 2026-05-29 15:02 | ✅ | 2026-05-29 15:02 |
| BMW Berlin Marathon<!--majors/berlin--> | ⭐ | ✅ | `bmw-berlin-marathon.com/en` | 2026-05-29 15:03 | ✅ | 2026-05-29 15:03 |
| Bank of America Chicago Marathon<!--majors/chicago--> | ⭐ | ✅ | `chicagomarathon.com` | 2026-05-29 15:04 | ✅ | 2026-05-29 15:04 |
| TCS New York City Marathon<!--majors/nyc--> | ⭐ | ✅ | `nyrr.org/races/tcsnycmarathon` | 2026-05-29 15:02 | ✅ | 2026-05-29 15:02 |
| TCS Sydney Marathon<!--majors/sydney--> | ⭐ | ✅ | `tcssydneymarathon.com` | 2026-05-29 15:02 | ✅ | 2026-05-29 15:02 |
| Schneider Electric Paris Marathon<!--majors/paris--> |  | ✅ | `schneiderelectricparismarathon.com/en` | 2026-05-29 15:04 | ✅ | 2026-05-29 15:04 |
| Brighton Marathon<!--majors/brighton--> |  | ✅ | `londonmarathonevents.co.uk/brighton-marathon-weekend` | 2026-05-29 15:02 | ✅ | 2026-05-29 15:02 |
| Volkswagen Prague Marathon<!--majors/prague--> |  | ✅ | `runczech.com/en/races/volkswagen-prague-marathon` | 2026-05-29 15:03 | ❌ 0 eventos | 2026-05-21 20:28 |
| Copenhagen Marathon<!--majors/copenhagen--> |  | ✅ | `copenhagenmarathon.dk/en` | 2026-05-29 15:03 | ✅ | 2026-05-29 15:03 |
| Edinburgh Marathon Festival<!--majors/edinburgh--> |  | ✅ | `edinburghmarathon.com` | 2026-05-29 15:04 | ✅ | 2026-05-29 15:04 |
| Stockholm Marathon<!--majors/stockholm--> |  | ✅ | `stockholmmarathon.se/eng` | 2026-05-29 15:04 | ✅ | 2026-05-29 15:04 |
| Manchester Marathon<!--majors/manchester--> |  | ✅ | `manchestermarathon.co.uk` | 2026-05-29 15:03 | ✅ | 2026-05-29 15:03 |
| Great North Run<!--majors/great_north_run--> |  | ✅ | `greatrun.org/events/great-north-run` | 2026-05-29 15:03 | ✅ | 2026-05-29 15:03 |
| Cardiff Half Marathon<!--majors/cardiff_half--> |  | ✅ | `cardiffhalfmarathon.co.uk` | 2026-05-29 15:02 | ✅ | 2026-05-29 15:02 |
| Manchester Half Marathon<!--majors/manchester_half--> |  | ✅ | `manchesterhalfmarathon.com` | 2026-05-29 15:04 | ✅ | 2026-05-29 15:04 |
| TCS Amsterdam Marathon<!--majors/amsterdam--> |  | ✅ | `tcsamsterdammarathon.nl/en` | 2026-05-29 15:04 | ✅ | 2026-05-29 15:04 |
| Venice Marathon<!--majors/venice--> |  | ✅ | `venicemarathon.it/en` | 2026-05-29 15:04 | ✅ | 2026-05-29 15:04 |
| Dublin City Marathon<!--majors/dublin--> |  | ✅ | `irishlifedublinmarathon.ie` | 2026-05-29 15:02 | ✅ | 2026-05-29 15:02 |
| Athens Classic Marathon<!--majors/athens--> |  | ✅ | `athensauthenticmarathon.gr/en` | 2026-05-29 15:02 | ✅ | 2026-05-29 15:02 |
| Valencia Trinidad Alfonso Marathon<!--majors/valencia--> |  | ✅ | `valenciaciudaddelrunning.com/en/marathon` | 2026-05-29 15:02 | ✅ | 2026-05-29 15:02 |
